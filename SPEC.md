...
| `E_RUNTIME` | A runtime tensor violates its declared shape, dtype, or device; a node's module raises during forward; registered state no longer matches the build; or the device is unavailable |
